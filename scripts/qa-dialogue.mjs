...
const handles=await page.locator('.reader-column-divider').count(); const columns=await page.locator('.utterances').first().evaluate(element=>getComputedStyle(element).gridTemplateColumns)
